...
{
    [Serializable]
    public partial class BWSFlowChart : DevExpress.XtraEditors.XtraUserControl
    {
        /// <summary>
        /// BWS流程图
        /// </summary>
        ...
        /// 流程图对象集合
        /// </summary>   
        [Category("FlowChart设置"), Description("是否为设计模式")]
        ...
        {
            FlowChartItem item = new FlowChartItem();
            item.Name = "新建模块" + (_FlowChartItem.Count + 1).ToString();
            item.Rect = rect;
            AddFlowChartItem(item);
        }
        /// <summary>
        ...
        private void BWSFlowChart_Paint(object sender, PaintEventArgs e)
        {
        ...
        private void BWSFlowChart_Load(object sender, EventArgs e)
        {
        ...
        private void BWSFlowChart_Click(object sender, EventArgs e)
        {
